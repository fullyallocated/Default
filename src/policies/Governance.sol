...
//         requests[0] = RequestPermissions("INSTR", INSTR.store.selector);
//         requests[1] = RequestPermissions("VOTES", VOTES.mintTo.selector);
//         requests[2] = RequestPermissions("VOTES", VOTES.burnFrom.selector);
//     }
